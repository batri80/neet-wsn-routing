"""
flow_simulate_mincost.py -- episode loop for the pure total-cost-
minimizing v3 objective.
"""
import numpy as np
...
def run_episode_v3_mincost(N=100, E0=0.5, R_c=30.0, sink_pos=None, beta=1.0,
                            Psi_c=None, Rc_thresh=None, max_rounds=4000, seed=0,
                            w=None, max_neighbors=15, record_series=True):
    ...
    for t in range(max_rounds):
        ...
        if current_solution is None:
            current_solution = solve_flow_lp_mincost(net, max_neighbors=max_neighbors)
            n_solves += 1
